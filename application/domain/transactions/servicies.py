...
class TransactionService(Service):
    ...
    async def register_transaction(self, from_account: Account, to_account: Account, amount: Money) -> Transaction:
    ...
    async def evaluate_transaction(self, account_service: AccountService, transaction: Transaction) -> Transaction:
        ...
        try:
            async with account_service.account_repo.atomic():
                await account_service.withdraw(transaction.from_account, transaction.sum)
